...
export interface WorkspacePageDef {
  id: 'registration' | 'basicDetails' | 'familyDetails' | 'visaDetails' | 'additionalQuestions'
  title: string
  subtitle: string
  pageNumber: number
  iconName: string
...
export const WORKSPACE_PAGES: WorkspacePageDef[] = [
  ...
  },
  {
    ...
    subtitle: 'Applicant Details & Passport Information',
    pageNumber: 2,
    iconName: 'User',
    subsections: ['Applicant Details', 'Passport Details'],
    fieldKeys: [
      'appl.surname',
      'appl.applname',
  ...
  },
  {
    ...
    subtitle: 'Present/Permanent Address, Family & Occupation Details',
    pageNumber: 3,
    iconName: 'Users',
    subsections: ["Applicant's Address Details", 'Family Details', 'Profession / Occupation Details'],
    fieldKeys: [
      'pres_addr1',
      'pres_addr2',
      'village_town_city',
  ...
  },
  {
    ...
    subtitle: 'Details of Visa Sought, Previous Visa & References',
    pageNumber: 4,
    iconName: 'Compass',
    subsections: ['Details of Visa Sought', 'Previous Visa Details', 'Other Information', 'SAARC Country Visits', 'Reference', 'Photograph'],
    fieldKeys: [
      'purpose',
      'duration',
      'visa_entry_id',
  ...
  },
  {
    ...
    subtitle: 'Statutory Legal & Security Declarations (Questions 1 to 6)',
    pageNumber: 5,
    iconName: 'ShieldAlert',
    subsections: ['Statutory Legal & Security Declarations', 'Applicant Declaration'],
    fieldKeys: [
      'question_1_flag',
      'answer_1',
      'question_2_flag',
