...
export const BANGLADESH_REGISTRATION_MAPPINGS: IndiaVisaFieldMapping[] = [
  ...
  {
    id: 'bd_reg_visiting_purpose',
    section: 'application-information',
    targetField: 'appl.purpose',
    sourceField: 'travel.purposeOfVisit',
    sourceType: 'confirmed-document',
    selector: BANGLADESH_REGISTRATION_SELECTORS.visitingPurpose,
    inputType: 'select',
    status: 'verified',
    required: false,
    page: 'REGISTRATION',
    notes: 'Visiting India for / Purpose of Visit (#purpose_id)',
  },
  {
    id: 'bd_reg_captcha',
    section: 'application-information',
